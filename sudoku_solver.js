...
module.exports.checkColumn = (board, column, value) => {
...
module.exports.check3x3Square = (board, column, row, value) => {
...
module.exports.checkValue = (board, column, row, value) => {
...
module.exports.solvePuzzle = (board, emptyPositions) => {
